...
class EditUserProfileDetail extends Component
{
    ...
    public function UpdateDetails(){
        ...
        $this->showToastr('Your Profile info has been updated successfully', 'success');
        return redirect('/users/profile');
    }
    ...
    {
        return view('livewire.edit-user-profile-detail');
    }
}
