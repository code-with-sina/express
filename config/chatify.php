...
return [
    ...
    |-------------------------------------
    */
    'name' => env('CHATIFY_NAME', 'Ratefy Transaction Messenger'),
    ...
    */
    'routes' => [
        'prefix' => env('CHATIFY_ROUTES_PREFIX', 'transactions/chatify'),
    ...
    'api_routes' => [
        ...
        'namespace' => env('CHATIFY_ROUTES_NAMESPACE', 'App\Http\Controllers\vendor\Chatify\Api'),
    ],
