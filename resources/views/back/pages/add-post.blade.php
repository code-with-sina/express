...
@section('pagetitle', isset($pagetitle) ? $pagetitle : 'Add New Posts')
@section('content')
                ...
                <div class="row gap-auto">
                    <div class="col-md-9">
                        <div class="mb-3">
                          ...
                          <input type="text"
                            class="form-control" name="post_title" id="" aria-describedby="helpId" placeholder="Enter Post Title">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="ckeditor form-control" id="ckeditor" name="post_content" rows="6" placeholder="Content.."></textarea>
