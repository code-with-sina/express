@php
        $chatNotification = \App\Models\ChatSubscription::orderBy('created_at', 'desc')->get();
    @endphp 
     @foreach ($chatNotification as $notification)
        ...
        @if($detail->transaction_status == 'processing')
            ...
            <div class="card mb-3">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                                ...
                                <small  class="text-secondary float-end text-muted mr-1"> {{ $detail->order_id }} </small> 
    ...
    @endphp 
     @foreach ($chatNotification as $notification)
        ...
        @if($detail->transaction_status == 'closed')
