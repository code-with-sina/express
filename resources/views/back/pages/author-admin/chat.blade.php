        ...
        <div class="col-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="#">Get Anchor balance is:  ₦ {{ $anchor_amount / 100 }}</a></li>
...
<div class="row">    
    @php 
        ...
        $detail = \App\Models\ExpressTransaction::where('transaction_status', 'pending')->latest()->paginate(5);
