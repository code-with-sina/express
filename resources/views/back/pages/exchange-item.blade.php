...
<div class="row mt-3">
    <div class="col-md-6 mx-auto">
        <form action="{{ route('author.create_option')}}" method="POST" id="addExchangeForm" enctype="multipart/form-data">
            @csrf
            <div class="card">
                <div class="card-body">
                    <div class="row gap-auto">
                        <div class="col-md-12">
                            <div class="mb-3">
                              ...
                              <input type="text"
                                class="form-control" name="name" id="" aria-describedby="helpId" placeholder="Paypal">
                                <span  class="form-text error-text name_error text-danger"></span>                          
                            </div>
                            <div class="mb-3">
                                <label for="" class="form-label">Sub Title</label>
                                <input type="text"
                                  class="form-control" name="sub_item" id="" aria-describedby="helpId" placeholder="sub title">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text"
                                  class="form-control" name="percentage" id="" aria-describedby="helpId" placeholder="0:00%">
                                  <span  class="form-text error-text percentage_error text-danger"></span>                          
                            </div>
                            
                            <div class="mb-3">
                                <div class="form-label">Exchange image</div>
                                <input type="file" class="form-control" name="exchange_image" id="exchange_image">
                                <span  class="form-text error-text exchange_image_error text-danger"></span>
                            </div>
                            <div class="mb-3">
                                <label for="" class="form-label">Currency</label>
                                <input type="text"
                                  class="form-control" name="currency" id="" aria-describedby="helpId" placeholder="USD, NGN, EUR, NIR">
                                  <span  class="form-text error-text sub_item_error text-danger"></span>                          
                            </div>
                            <div class="mb-3">
                                <label for="" class="form-label">Seller's Note</label>
                                <textarea 
                                  class="form-control" name="seller_note" id="" aria-describedby="helpId" placeholder="Seller's Note"></textarea>
                                  <span  class="form-text error-text sub_item_error text-danger"></span>                          
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3 image_holder" style="max-width: 300px;">
                                <img src=""  class="img-thumbnail w-full"  id="image-preview" data-ijabo-default-image="">
                            </div>
