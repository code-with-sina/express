   ...
   <div class="row mb-3">
    <div class="card">
      <ul class="nav nav-tabs" data-bs-toggle="tabs">
        <li class="nav-item">
          <a href="#tabs-general" class="nav-link active" data-bs-toggle="tab">General Settings</a>
        </li>
        <li class="nav-item">
          <a href="#tabs-logo" class="nav-link" data-bs-toggle="tab">Logo & Favicon</a>
        </li>
        <li class="nav-item">
          <a href="#tabs-social" class="nav-link" data-bs-toggle="tab">Social Media</a>
        </li>
      </ul>
      <div class="card-body">
        <div class="tab-content">
          <div class="tab-pane fade active show" id="tabs-general">
            <div>
                <livewire:author-general-settings />
            </div>
          </div>
          <div class="tab-pane fade" id="tabs-logo">
            <div>
              <div class="row">
                <div class="col-md-6">
                  <h2>
                ...
                <div class="col-md-6">
                  ...
                  <div class="mb-2" style="max-width: 100px">
                    <img src="" alt="" id="favicon-image-preview" class="img-thumbnail" data-ijabo-default-img="{{ \App\Models\Setting::find(1)->blog_favicon}}">
                  </div>
          ...
          <div class="tab-pane fade" id="tabs-social">
            <div>
