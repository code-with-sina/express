...
<body class="bg-ratefy-primary">
    <main class="container-fluid text-white mx-0 my-0 py-0 px-0">
        ...
        <div class="continer-fuild complete-transaction-status-and-countdown">
            <div class="container px-5 py-4">
                <div class="row">
                    <div class="col-md-6">
                        <h4 class="heading">
                            <span class="light">Completed</span>, We’ve sent you Naira!
                        </h4>
                        <p class="paragraph">
                            Good news; Ratety has sent the Naira payment on your way.
                                ...
                                <div class="col-12 my-4">
                                    <div class="row">
                                        <div class="col-4 d-grid">
                                           <button class="btn btn-secondary rounded-5 py-1 order-card-button">APPEAL</button> 
                                        </div>
                                        <div class="col-8 d-grid">
                                            <button class="btn btn-success rounded-5 py-1 order-card-button">PAYMENT RECEIVED</button> 
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="container-fluid text-dark">
                           <div class="card rounded-4 w-100">
                                <form action="#" method="post">
                                    @csrf
                                    <div class="card-body text-dark px-5 py-5">
                                    <div class="container-fluid px-3 py-5 m-0">
                                        ...
                                        <input type="text" name="" class="form-control w-100 border-0 border-bottom bg-white mb-5" id="">
                                        <p class="rate-form-text">
                                            What do you like most about Zoommit?
                                        </p>
                                        <input type="text" name="" class="form-control w-100 border-0 border-bottom bg-white mb-5" id="">
                                        <p class="rate-form-text"> 
