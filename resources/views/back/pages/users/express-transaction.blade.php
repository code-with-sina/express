...
<body class="bg-ratefy-primary w-100" style="overflow-x:hidden;" onload="checkDevice()">
                                        ...
                                        <div class="card-body px-2 px-sm-2 px-md-5 py-3">
                                            <div class="row p-0 m-0 mb-2">
                                                <div class="col-1 px-0 py-1">
                                                    ...
                                                    @endphp
                                                    <img src="/storage/images/exchange_images/thumbnails/thumb_{{ $image->image_path ?? '' }}" alt="" height="30" class="card-order-info">
                                                </div>
                                ...
                                <div class="col-12 my-2">
                                    ...
                                    <div class="border border-secondary rounded-1  px-0 px-sm-0 px-md-3 py-2">
                                        <form id="file_form" enctype="multipart/form-data">
                                            ...
                                            <small id="pop-path" class="text-white" style="font-size: 12px !important;"> 
                                                @if ($props->pop_path !== null)
                                                    {{ $props->pop_path }}
                                                @endif    
                                            </small>
                                            
                                            <button class="btn btn-secondary my-0 rounded-5 float-end @if ($props->pop_path !== null)
                                                    invisible
                                                @endif" id="submitpop">Submit prove</button> 
                                        </form>
                                    </div>
                                </div>
    ...
    <script>
        ...
        let popPath     = document.getElementById('pop-path');        
    ...
    @php
        $time = \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $props->express_binding_detail_end_time);
    @endphp
