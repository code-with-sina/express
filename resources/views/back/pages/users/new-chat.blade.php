...
<html lang="en">
  <head>
    ...
    @vite(['resources/js/app.js', 'resources/js/newchat.js'])
    <link rel="stylesheet" href="{{ asset('ratefy/custom.css')}}">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.3/font/bootstrap-icons.css">
    <livewire:styles />
  </head>
  <body class="d-flex justify-content-center">

        <div class="chat-body-height chat-body-width py-3">
            <div class="container">
                &nbsp; 
                @php 
                            ...
                            <div class="col-8">
                                <div class="row m-0 p-0">
                                    <div class="col-6 d-flex align-items-center">
                                        <a href="{{ route('users.activities') }}" class="text-white nav-link"><i class="bi bi-chevron-left"></i>
                                        <span class="nav-left-font">Transaction History</span></a>
                                    </div>
                                    <div class="col-6">
                    ...
                    <div class="col-8 m-0 p-0">
                        <div class="row m-0 p-0">
                            <div class="col-12 m-0 p-0">
                                <livewire:new-chat-desktop>
                                
                            </div>
                        </div>
                        <div class="row m-0 p-0 chat-arean">
                            
                            <div id="list-message" class="container m-0 px-5 pt-3 chat-div position-relative">
                            ...
                            <div class="container">
                                <div class="row my-2">
                                    <div class="col-11 position-relative"> 
                                        <div class="row">
                                            <div class="col-12 position-relative mb-1">
                                                ...
                                                <div class="container justify-content-start z-index position-absolute bottom-0 start-0">
                                                    <div class="row px-2">
                                                        <div class="col-7">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-7 position-relative m-0 p-0">
                                                                    <div class="row">
                                    ...
                                    <div class="col-1 d-flex align-items-top">
                                        <img src="/front/image/send.svg" alt="send" id="send">
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-4 reciept-area">
                            @php
                                $image = \App\Models\ExchangeItem::where('id', $props->wallet_id)->first();
                            @endphp
                        <div class="row inner-chat-body px-2">
                            <div class="clo-12 py-3">
                                <p class="float-end reciept-header p-0 pb-4 m-0">
                                    ORDER DETAILS
                                </p>
                                ...
                                <p class="float-end receipt-body p-0 m-0">
                                    Order Id : <b>{{ substr($props->order_id, 0,  20) }} <i class="bi bi-clipboard-check super"></i></b>
                                </p>
                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-3 d-flex align-items-center">
                                                    <div class="recipient-img d-flex align-items-top">
                                                        <img src="/front/image/customer-care.png" alt="merchant">
                                                    </div>
                                                </div>
                                                <div class="col-9">
                                                    <div class="row py-0">
                                                ...
                                                <div class="col-12 m-0 p-0">
                                                   <div class="row m-0 px-3">
                                                        ...
                                                        <div class="col-12 py-2 user-list">
                                                            ...
                                                            <p class="text-white user-receipt-list-subtitle py-0 px-1 d-flex justify-content-end">
                                                                <img src="/storage/images/exchange_images/thumbnails/thumb_{{ $image->image_path ?? '' }}" alt="" class="wallet-img me-1"> {{ $props->wallet_name}} 
                                                            </p>
                                                        </div>
                                                        <div class="col-12 py-2 user-list">
                                                            <p class="text-white user-receipt-list-title py-0">
                            ...
                            <div class="col-12 py-2">
                                ...
                                <button class="btn feedback-positive float-end me-2" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                    Feedback
                                </button>
        ...
        <div class="modal fade" id="thanksFeedBack" id="staticBackdrop" data-bs-backdrop="static" tabindex="-1" aria-labelledby="thanksFeedBack" aria-hidden="true">
            ...
            <div class="modal-content rounded-0 feedback p-0 m-0">
                ...
                <div class="modal-body border border-0 pb-5 mb-2">
                    ...
                    <p class="text-center fs-6 text-secondary px-5 mx-5">Absolutely fast and polite. I will use next time.</p>
                </div>
            </div>
            </div>
        </div>
    ...
    <script>
        ...
        submitFeedBack.addEventListener("click", function(){
            if(!feedstatus){
                ...
                // alert("Kindly choose a positive or negative feedback status button");
            }
        });
