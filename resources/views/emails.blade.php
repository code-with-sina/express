...
<head>
    ...
    <style type="text/css">
        ...
        .title-2 button {
            ...
            background: #00B172;
            /* background: linear-gradient(92.42deg, #0CCDA3 0.59%, #3AFF4E 55.84%); */
...
<body style="margin: 20px auto;">
    <table align="center" border="0" cellpadding="0" cellspacing="0"
        style="background-color: #000; width: 100%; box-shadow: 0px 0px 14px -4px rgba(0, 0, 0, 0.2705882353);-webkit-box-shadow: 0px 0px 14px -4px rgba(0, 0, 0, 0.2705882353);">
        <tbody>
            <tr>
                <td>
                            ...
                            <td class="header-contain" style="display: block;">
                                <ul>
                                    ...
                                    <li style="display: block;text-decoration: unset" class="reset-contain">
                                        ...
                                        <h4 class="market">That's okay,it happens! Click on the button below to reset
                                            your password</h4>
                    ...
                    <table class="text-center" align="center" border="0" cellpadding="0" cellspacing="0" width="100%"
                        style="margin-top:40px; background: linear-gradient(97deg, rgba(65,179,136,1) 0%, rgba(43,180,122,1) 45%, rgba(8,171,156,1) 82%); color: white; padding: 40px 0;">
                        <tr>
                            <td>
