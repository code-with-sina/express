                            ...
                            <td class="header-contain" style="display: block;">
                                <ul>
                                    <li style="display: block;text-decoration: unset;">
                                        <img src="{{ asset('front/image/admin-notification.jpg') }}" width="100%" alt="Ratefy.co">
                                    </li>
                        ...
                        <thead>
                            <tr>
                                <div class="title title-2 text-center">
                                    <h2 class="title-2" style="font-size: 18px !important; margin-left: 15px; margin-bottom: 15px;">Hello Admin,</h2>
