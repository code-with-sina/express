                        ...
                        <thead>
                            <tr>
                                <div class="title title-2 text-center">
                                    <h2 class="title-2" style="font-size: 18px !important; margin-left: 15px; margin-bottom: 15px;">Hi  {{ $name }},</h2>

                                </div>
                                <div class="title title-2">
                                    <p style="font-size: 12px; margin-left: 15px;">
                                    You have an unread message from Ratefy Admin. Kindly go back to your active transaction chat box to check and respond to your message.
                                    </p>
                                    <p style="font-size: 12px; margin-left: 15px;">
