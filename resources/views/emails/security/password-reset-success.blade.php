                            ...
                            <tr>
                                ...
                                <div class="title title-2">
                                    ...
                                    <p style="font-size: 12px; margin-left: 15px;">
                                        This message is to confirm that your Ratefy account password has been successfully changed.
                                    </p> 
                                    <p style="font-size: 12px; margin-left: 15px;">
                                        If you did not request a password change, please  <a href="mailto:{{ env('MAIL_FROM_ADDRESS') }}">contact us immediately. </a>    
                                    </p>     
