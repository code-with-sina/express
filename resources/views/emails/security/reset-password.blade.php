                            ...
                            <tr>
                                ...
                                <div class="title title-2">
                                    ...
                                    <p style="font-size: 12px; margin-left: 15px;">
                                        You recently requested to reset the password for your {{ $email }}  account. Click the button below to proceed.
                                    </p> 
                                    <p style="font-size: 12px; margin-left: 15px;">
                                        <a href="{{ $link }}" style="padding: 10px 20px !important;  background-color: #00B172; color: #fff; border-radius: 7px !important;">Reset Password</a>    
                                    </p>   
                                    <p style="font-size: 12px; margin-left: 15px;">
