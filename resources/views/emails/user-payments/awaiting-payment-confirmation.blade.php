                            ...
                            <tr>
                                ...
                                <div class="title title-2">
                                    <p style="font-size: 12px; margin-left: 15px;">
                                       ...
                                       <br>
                                       <b>OrderId: </b> <span style="font-style: italic; font-size: 9px; margin-bottom: 20px; "> {{ $transactionId }} </span>
                                        <br>
                                        <span style="font-style: italic; font-size: 9px; margin-bottom: 20px; ">Kindly wait while the receiver confirms your payment.</span>
                                        <br>
                                        <span style="font-style: italic; font-size: 9px; margin-bottom: 20px;"> {{ date('d-m-Y', strtotime($created)) }} </span>
