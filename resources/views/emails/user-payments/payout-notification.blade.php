                            ...
                            <tr>
                                ...
                                <div class="title title-2">
                                    <p style="font-size: 12px; margin-left: 15px;">
                                        Your payout for transaction {{ $transactionId }} should be in your bank account within the next 10 minutes.
                                    ...
                                    <p style="font-size: 12px; margin-left: 15px;">
                                        <span style="border-bottom: 1px solid #888aaa; padding-bottom: 2px; font-size: 18px; font-weight: 500;">  ₦{{ $amount }}.00 </span>
                                        <br>
                                        <br>
