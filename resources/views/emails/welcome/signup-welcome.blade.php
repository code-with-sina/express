                            ...
                            <td class="header-contain" style="display: block;">
                                <ul>
                                    <li style="display: block;text-decoration: unset;">
                                        <img src="{{ asset('front/image/welcome.jpg') }}" alt="Ratefy.co" width="100%">
                                    </li>
                            ...
                            <tr>
                                ...
                                <div class="title title-2">
                                    <p style="font-size: 12px; margin-left: 15px;">
                                        Welcome to Ratefy – we’re excited to have you on board🤩
                                    </p>
                                    <p style="font-size: 12px; margin-left: 15px;">
                                        ...
                                        <br>
                                        This video <a href="https://youtu.be/9AdmQgWQUZQ">Ratefy.co</a> walks you through setting up your Ratefy account for the first time. 
                                        <br>
                                        Our FAQ <a href="https://ratefy">Ratefy.co</a> is a great place to find the answers to common questions you might have as a new user. 
                                        <br>
                                        Our Youtube channel <a href="https://www.youtube.com/channel/UChJ99l34thtPUOsvS4OxQsg">Ratefy</a> has work-through on various ways you can use Ratefy. 
                                        <br>
                                        Our blog <a href="https://ratefy.co/blog">Blog</a> has some great tips and best practices to ensure you freelance journey is a success.
                                        Have any questions or need more information? Just shoot us an email! We’re always here to help. 
                                        <br>
                                        <br>
                                        <br>
                                        
                                        <span style="font-size: 10px font-style: italic;"> Feel free to hit us up on Instagram <a href="https://www.instagram.com/ratefy.co/">Ratefy.co</a> or Twitter <a href="https://twitter.com/_Ratefy">Ratefy.co </a> , if you want a fast response, too.</span>
