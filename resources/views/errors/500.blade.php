  ...
  <div class="container-fluid text-white py-5 py-lg-5 m-0">
        <div class="row p-lg-5 m-0">
            <div class="col-12 col-lg-6 py-lg-5 pt-5 py-lg-3 order-lg-2">
                <img src="/front/image/505.png" alt="500" class="img-fluid" />
            </div>
            <div class="col-12 col-lg-6 px-lg-5 py-lg-5 order-lg-1">
              <div class="w-100 ps-lg-5 pt-lg-5">
                <h1 class="pt-5 display-1 text-center text-lg-start">Opps, <br> Something <br> Went Wrong</b></h1>
                <p class="text-center text-lg-start">There is an issue with this page. Kindly bear with us.</p>
                ...
                <div class="w-100">
                  <div class="row">
                    ...
                    <div class="col-12 col-lg-6 d-grid">
                      <a href="mailto:femi@ratefy.co" class="btn btn-light rounded-5 px-3 m-2">Let Us know</a>
                    </div>
                  </div>
                </div>
              </div> 
