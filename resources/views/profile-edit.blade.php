                            ...
                            <nav class="navbar navbar-expand-lg navbar-dark bg-body-tertiary dashnoard-active-bar-thin-line py-0 px-0">
                                <div class="container-fluid px-0">
                                  <div class="collapse navbar-collapse" id="navbarNav">
                                    <ul class="navbar-nav">
                                      <li class="nav-item">
                                        <a class="nav-link active-active dashboard-inner-active-bar" href="#">Profile</a>
                                      </li>
                                    </ul>
                                  </div>
                                </div>
                                ...
                                <div class="col-md-12 dashboard-activity-box my-2">
                                    <div class="row p-5">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text"  class="form-control dashboard-timer dashboard-activity-box" id="staticEmail" value="dior">
                                            </div>
                                            <div class="col-md-4">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text"  class="form-control dashboard-timer dashboard-activity-box" id="staticEmail" value="odeyemi Femi">
                                            </div>
                                            <div class="col-md-4">
                                            </div>
                                        </div>
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text"  class="form-control dashboard-timer dashboard-activity-box" id="staticEmail" value="eail@example.com">
                                            </div>
                                            <div class="col-md-4">
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-12 dashboard-activity-box my-2">
                                    <div class="row p-5">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <p>No 8 Surulere Oke Ola Gbongan</p>
                                            </div>
                                            <div class="col-md-4">
                                                <span class="float-end">
                                                    <i class="bi bi-pencil-fill h4 dashboard-timer"></i>
