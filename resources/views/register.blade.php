                                ...
                                <div class="col-12">
                                    <form action="" method="post" class="mb-3">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control form-control-lg  border border-start-0 rounded-end bg-white" placeholder="Phone Number" aria-label="Username" aria-describedby="basic-addon1">
                                        </div>
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control form-control-lg  border border-start-0 rounded-end bg-white" placeholder="Loki Loyfenson" aria-label="Email address" aria-describedby="basic-addon1">
                                        </div>
                                        <div class="input-group mb-3">
                                        ...
                                        <div class="input-group mb-4">
                                            <span class="input-group-text border border-end-0 rounded-start bg-white px-3"><i class="bi bi-lock"></i></span>
                                            <input type="text" class="form-control form-control-lg border border-0 border-top border-bottom bg-white" aria-label="Amount (to the nearest dollar)" placeholder="Cofirm Password">
                                            <span class="input-group-text border border-start-0 rounded-end bg-white px-3"><i class="bi bi-eye"></i></span>
                                        </div>
                                        <div class="d-grid gap-2">
                                            <button class="btn btn-primary py-2 rounded-5 button-bg" type="button">Sign up</button>
                                        </div>
                                    </form>
                                    <p class="text-center">
                                        <span class="ratefy-auth-paragraphs">Already have an account?</span> <a href="#" class="ratefy-auth-links">Log in</a>
                                    </p>
                                </div>
                            </div>
                        </div>
